...
document.addEventListener('click', (e)=>{
    ...
    if (targetX < wallRect.left) targetX = wallRect.left;
    else if (targetX + spiderWidth > wallRect.right) targetX = wallRect.right - spiderWidth;
    if (targetY < wallRect.top) targetY = wallRect.top;
    else if (targetY + spiderHeight > wallRect.bottom) targetY = wallRect.bottom - spiderHeight;
